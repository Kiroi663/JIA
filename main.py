...
class JobBot:
    ...
    async def initialize(self):
        ...
        try:
            ...
            session_name = f"jobfinder_session_{int(datetime.now().timestamp())}"
            self.bot = TelegramClient(session_name, offreBot.API_ID, offreBot.API_HASH)
    ...
    def setup_handlers(self):
        ...
        async def start_handler(event):
            try:
                ...
                print(f"Erreur dans start_handler: {str(e)}")
        ...
        async def verify_handler(event):
            try:
                ...
                print(f"Erreur dans verify_handler: {str(e)}")
        ...
        async def show_categories_handler(event):
            try:
                ...
                print(f"Erreur dans show_categories: {str(e)}")
        ...
        async def show_main_menu_handler(event):
            try:
                ...
                print(f"Erreur dans show_main_menu: {str(e)}")
        ...
        async def category_handler(event):
            try:
                ...
                print(f"Erreur dans category_handler: {str(e)}")
        ...
        async def page_handler(event):
            try:
                ...
                print(f"Erreur dans page_handler: {str(e)}")
        ...
        async def quit_handler(event):
            try:
                ...
                print(f"Erreur dans quit_handler: {str(e)}")
        ...
        async def show_favorites_handler(event):
            try:
                ...
                print(f"Erreur dans show_favorites: {str(e)}")
        ...
        async def fav_category_handler(event):
            try:
                ...
                print(f"Erreur dans fav_category_handler: {str(e)}")
        ...
        async def show_advanced_search_handler(event):
            try:
                ...
                print(f"Erreur dans show_advanced_search: {str(e)}")
    ...
    async def show_welcome(self, event, user):
        ...
        try:
            ...
            print(f"Erreur dans show_welcome: {str(e)}")
    ...
    async def request_join_group(self, event, user):
        ...
        try:
            ...
            print(f"Erreur dans request_join_group: {str(e)}")
    ...
    async def handle_category_selection(self, event):
        ...
        try:
            ...
            print(f"Erreur dans handle_category_selection: {str(e)}")
    ...
    async def send_job_page(self, event, chat_id):
        ...
        try:
            ...
            print(f"Erreur dans send_job_page: {str(e)}")
    ...
    async def handle_pagination(self, event):
        ...
        try:
            ...
            print(f"Erreur dans handle_pagination: {str(e)}")
    ...
    async def quit_category(self, event):
        ...
        try:
            ...
            print(f"Erreur dans quit_category: {str(e)}")
    ...
    async def show_favorites(self, event):
        ...
        try:
            ...
            buttons = [[Button.inline(f"{'✅' if cat in current else '◻️'} {cat}", f"fav_category_{cat}")] 
    ...
    async def toggle_favorite_category(self, event):
        ...
        try:
            ...
            print(f"Erreur dans toggle_favorite_category: {str(e)}")
    ...
    async def check_new_jobs(self):
        ...
        try:
            ...
            print(f"Erreur dans check_new_jobs: {str(e)}")
    ...
    async def notify_subscribers(self, category, job_data):
        ...
        try:
            template = random.choice(self.templates).format(
                ...
                location=job_data.get("location", "Non specifié"),
                resume=job_data.get("description", "Plus de Description via le lien ci-dessous")
            )
            ...
            print(f"Erreur dans notify_subscribers: {str(e)}")
    ...
    async def run_bot(self):
        ...
        try:
            ...
            async def notification_loop():
                while True:
                    try:
                        ...
                        print(f"⚠️ Erreur boucle notification: {str(e)}")
            ...
            print(f"⚠️ Erreur critique dans run_bot: {str(e)}")
        finally:
            if self.bot:
                await self.bot.disconnect()
...
def add_job():
    ...
    async def async_add_job():
        try:
            ...
            print(f"Erreur ajout job: {str(e)}")
            return False
...
if __name__ == "__main__":
    ...
    for file in os.listdir():
        if file.startswith("jobfinder_session_") and file.endswith(".session"):
            try:
                os.remove(file)
                print(f"🗑️ Session supprimée: {file}")
            except Exception as e:
                print(f"Erreur suppression session: {str(e)}")
